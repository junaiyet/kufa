                    ...
                    <div class="col-xl-12">
                        <div class="main-menu">
                            <nav class="navbar navbar-expand-lg">
                                <a href="index.html" class="navbar-brand logo-sticky-none"><img width="200" src="uploads/logo/<?= $after_assoc_logo['logo'] ?>" alt="Logo"></a>
    ...
    <main>
                ...
                <div class="row align-items-center">
                    <div class="col-xl-7 col-lg-6">
                        <div class="banner-content">
                            ...
                            <p class="wow fadeInUp" data-wow-delay="0.6s">
                                <?= $after_assoc_banner_content['desp'] ?>
                            </p>
                    ...
                    <div class="col-xl-5 col-lg-6 d-none d-lg-block">
                        <div class="banner-img text-right">
                            <img width="600" src="uploads/banners/<?= $after_assoc_banner_image['banner_image'] ?>" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section id="about" class="about-area primary-bg pt-120 pb-120">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="about-img">
                            <img src="uploads/about/<?= $after_assoc_about_content['image'] ?>" title="me-01" alt="me-01" class="w-100">
                        </div>
                    </div>
        ...
        <section id="portfolio" class="portfolio-area primary-bg pt-120 pb-90">
            <div class="container">
                ...
                <div class="row">
                    <?php foreach ($select_works_content_result as $work) : ?>
                            ...
                            <?php foreach ($select_feedbacks_result as $feedback) : ?>
                                <div class="single-testimonial text-center">
                                    <div class="testi-avatar">
                                        <img width="100" height="100" src="uploads/feed/<?= $feedback['image'] ?>" alt="img">
                                    </div>
                    ...
                    <?php foreach ($select_client_result as $client) : ?>
                        <div class="col-xl-2">
                            <div class="single-brand">
                                <img width="125" src="uploads/client/<?= $client['client'] ?>" alt="img">
                            </div>
                        </div>
                    <?php endforeach ?>
                </div>
