...
$select_result = mysqli_query($db_connection, $select_work);
                    ...
                    <div class="col-xl-9 col-lg-10">
                        <div class="single-blog-list">
                            <div class="blog-list-thumb mb-35">
                                <img src="uploads/works/<?= $after_assoc['image'] ?>" alt="img">
                            </div>
                                ...
                                <div class="blog-list-meta">
                                    <ul>
                                        ...
                                        <li class="blog-post-share">
                                            <a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=http://127.0.0.1/Jett/portfolio-single.php?id=<?= $id ?>"><i class="fab fa-facebook-f"></i></a>
                                            <a target="_blank" href="https://twitter.com/intent/tweet?url=http://127.0.0.1/Jett/portfolio-single.php?id=<?= $id ?>"><i class="fab fa-twitter"></i></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div class="avatar-post mt-70 mb-60">
                                ...
                                $select2_result = mysqli_query($db_connection, $user);
                                $after_assoc2 =  mysqli_fetch_assoc($select2_result);
                                ?>
                                <ul>
                                    <li>
                                        <div class="post-avatar-img">
                                            <img width="100" height="100" src="uploads/users/<?= $after_assoc2['profile_photo'] ?>" alt="img">
                                        </div>
                                        <div class="post-avatar-content">
                                            <h5><?= $after_assoc2['name'] ?></h5>
