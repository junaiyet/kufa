            ...
            <div class="row">
                <div class="col-lg-12 m-auto">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="icon p-2" style="background: #f5f5f5; height:400px;overflow:scroll;cursor:pointer;font-size:20px">
                                <?php foreach ($fonts as $icon) { ?>
                                    <i class="m-2 social_icon fa <?= $icon ?>" name="<?= $icon ?>"></i>
                                <?php } ?>
                            </div>
                            <form action="icon_post.php" method="POST">
                                <div class="mt-3 pos-lg-relative">
                                    ...
                                    <i style="position: absolute;top:40px;left:10px" class="fa " id="icon2"></i>
                                </div>
                                <div class="mt-3">
